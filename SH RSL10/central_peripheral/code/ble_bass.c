...
/* ----------------------------------------------------------------------------
 * Function      : void Batt_LevelUpdateSend(uint8_t conidx, uint8_t batt_lvl, uint8_t bas_nb)
 * ----------------------------------------------------------------------------
...
void Batt_LevelUpdateSend(uint8_t conidx, uint8_t batt_lvl, uint8_t bas_nb)
{
    ...
    req = KE_MSG_ALLOC(BASS_BATT_LEVEL_UPD_REQ,
                       prf_src_task_get(&(bass_env->prf_env), conidx), TASK_APP,
...
/* ----------------------------------------------------------------------------
 * Function      : void Batt_EnableRsp_Server(ke_msg_id_t const msg_id,
